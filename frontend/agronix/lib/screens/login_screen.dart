...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  void _setupAnimations() {
    ...
    _fadeAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: _mainAnimationController, curve: const Interval(0.0, 0.8, curve: Curves.easeOut)),
    );
    _slideUpAnimation = Tween<Offset>(
      begin: const Offset(0, 0.3),
      end: Offset.zero,
    ).animate(CurvedAnimation(parent: _mainAnimationController, curve: const Interval(0.2, 1.0, curve: Curves.easeOutCubic)));
                    ...
                    _buildTextField(
                      ...
                      validator: (value) {
                        ...
                        if (!value.endsWith('@agronix.com')) {
                          return 'Solo se permiten emails con dominio @agronix.com';
                        }
